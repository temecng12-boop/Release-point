    ...
    <div className="min-h-screen bg-[#060F1A] text-[#E8EDF5]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 space-y-10">
        <div>
          ...
          <h1 className="text-4xl text-[#E8EDF5] mb-2" style={oswald}>Terms of Service</h1>
        ...
        <div className="bg-[#0B1E36] border border-[#1C3A5C] rounded-lg p-5">
          <p className="text-xs text-[#9FB3CC] leading-relaxed">
            <strong className="text-[#E8EDF5]">Note:</strong> These Terms of Service are provided in good faith. They do not constitute legal advice. For compliance requirements specific to your organization, consult a licensed attorney.
          </p>
        </div>
...
Upon termination, your content will be deleted within 30 days unless we are required by law to retain it.`,
          ...
          <div key={section.title}>
            ...
            <div className="text-sm text-[#9FB3CC] leading-relaxed">
              {section.body.split('\n').map((line, i) => {
