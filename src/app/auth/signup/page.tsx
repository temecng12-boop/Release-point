  ...
  return (
    <div className="mt-5 space-y-2">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 bg-black hover:bg-[#1a1a1a] border border-black rounded-lg py-3 text-sm text-white transition-all"
      >
