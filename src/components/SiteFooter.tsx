      ...
      <footer className="px-5 md:px-8 py-6 mt-8" style={{ borderTop: '1px solid #e2e8f0' }}>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-xs text-slate-400">
          <span>Designed &amp; built by{' '}
            <a href="https://www.linkedin.com/in/nolangeorge12" target="_blank" rel="noopener noreferrer"
              className="text-slate-500 hover:text-slate-700 transition-colors hover:underline underline-offset-2">
              Nolan George
            </a>
          </span>
          <span className="hidden sm:inline text-slate-300">·</span>
          <a href="https://www.linkedin.com/company/release-point-ai/" target="_blank" rel="noopener noreferrer"
